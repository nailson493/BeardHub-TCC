      ...
      <!-- <div class="flex items-center md:order-2">
        <button type="button"  class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
         ...
         <div class="flex relative items-center lg:order-2" id="text-header">
            ...
            <a href="painel.php?r=login" class="text-white  hover:bg-zinc-400  focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg-px-5 py2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800 ">Sign Up</a>
