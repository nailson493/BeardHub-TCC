                                    ...
                                    <div  class="overflow-hidden shadow sm:rounded-md ">
                                        ...
                                        <div class="grid grid-cols-3 gap-4 w-[32rem] mb-4 mt-10 ">
                                          <div class="col-span-1">
                                              ...
                                              <select id="monday" name="monday" autocomplete="segunda-name" onchange="segunda()" class="mt-1 block w-full rounded-md border w-full border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
