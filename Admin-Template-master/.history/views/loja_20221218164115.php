...
<label class="inline-flex relative items-center cursor-pointer">
  ...
  <input type="text" name="closed-monday" id="closed-monday" autocomplete="family-name" value="18:30" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
</label>
