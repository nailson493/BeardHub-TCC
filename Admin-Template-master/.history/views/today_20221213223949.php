...
<main>
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <!-- Dropdown menu -->aria-labelledby="dropdownDefault
                                <div id="dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700">
                                <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left aria-labelledby="dropdownDefault">
                                <li>
