                                ...
                                <form  action="#" method="POST">
                                    <div  class="overflow-hidden shadow sm:rounded-md ">
                                                <div class="bg-white px-4 py-5 sm:p-6">                                                    
                                                    ...
                                                    <div class="grid grid-rows-3 grid-flow-col gap-4 bg-white w-10 ">
                                                        <div class="col-span-2 ml-6"> 
                                                            <label for="city" class="block text-sm font-medium text-green-700 ">Estilo</label>
                                                            <input type="text" name="estilo" id="estilo" autocomplete="address-level2" class="w-10 mt-1 block rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                                        </div>
                                                        <div class="row-span-2 col-span-2 absolute mt-20 ml-6"> 
