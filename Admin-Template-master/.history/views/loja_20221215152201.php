                                ...
                                <form  action="#" method="POST">
                                    <div  class="overflow-hidden shadow sm:rounded-md ">
                                        ...
                                        <div  class="grid grid-cols-6 gap-6">
                                            ...
                                            <input type="text" name="estabelecimento-name" id="estabelecimento-name" autocomplete="given-name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" disabled>
                                            </div>
                                        ...
                                        <label for="country" class="block text-sm font-medium text-gray-700">Quinta</label>
                                            ...
                                            <label for="city" class="block text-sm font-medium text-green-700">Inicio</label>
                                            <input type="text" name="city" id="city" autocomplete="address-level2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" disabled>
                                            <label for="city" class="block text-sm font-medium text-red-700">Encerramento</label>
                                            <input type="text" name="city" id="city" autocomplete="address-level2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" disabled>
                                        </div>
                                        <div>
