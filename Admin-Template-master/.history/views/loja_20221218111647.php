                                                ...
                                                <div  class="grid grid-cols-6 gap-6">
                                                        ...
                                                        <div class="grid grid-cols-3 gap-4 w-[32rem] mb-4 mt-10 justify-start">
                                                            <div class="col-span-1">
                                                                ...
                                                                <select id="monday" name="monday" autocomplete="monday-name" onchange="openAndClosed('monday','open-monday','clmonday')" class="mt-1 block w-full rounded-md border w-full border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
