                                                        ...
                                                        <div class="grid grid-cols-3 gap-4 w-[32rem] mb-4 mt-10 justify-start">
                                                            ...
                                                            <div class="col-span-6 sm:col-span-1">
                                                              ...
                                                              <div class="col-span-1">
                                                                ...
                                                                <select id="tuesday" name="tuesday" autocomplete="tuesday-name" onchange="openAndClosed('t','open-sunday','closed-sunday')" class="mt-1 block w-full rounded-md border w-full border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                                                    <option value="open" >Aberto</option>
                                                                    <option value="closed" >Fechado</option>
                                                                </select>
                                                              </div>
                                                              <div class="col-span-6 sm:col-span-1">
                                                                ...
                                                                <select id="wednesday" name="wednesday" autocomplete="wednesday-name" onchange="openAndClosed('sunday','open-wednesday','closed-wednesday')" class="mt-1 block w-full rounded-md border w-full border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                                                    <option value="open" >Aberto</option>
                                                                    <option value="closed" >Fechado</option>
                                                                </select>
                                                              </div>
                                                              <div class="col-span-6 sm:col-span-1">
                                                                ...
                                                                <select id="thursday" name="thursday" autocomplete="thursday-name" onchange="openAndClosed('sunday','open-thurday','closed-thursday')" class="mt-1 block w-full rounded-md border w-full border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                                                    <option value="open" >Aberto</option>
                                                                    <option value="closed" >Fechado</option>
                                                                </select>
                                                              </div>
                                                              <div class="col-span-6 sm:col-span-1">
                                                                ...
                                                                <select id="friday" name="friday" autocomplete="friday-name" onchange="openAndClosed('sunday','open-friday','closed-friday')" class="mt-1 block w-full rounded-md border w-full border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                                                    <option value="open" >Aberto</option>
                                                                    <option value="closed" >Fechado</option>
                                                                </select>
                                                              </div>
                                                              <div class="col-span-6 sm:col-span-1">
                                                                ...
                                                                <select id="saturday" name="saturday" autocomplete="saturday-name" onchange="openAndClosed('sunday','open-saturday','closed-saturday')" class="mt-1 block w-full rounded-md border w-full border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                                                    <option value="open" >Aberto</option>
                                                                    <option value="closed" >Fechado</option>
                                                                </select>
                                                              </div>
