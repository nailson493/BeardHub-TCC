                                                    ...
                                                    <table class="w-96 text-sm text-left text-gray-100 dark:text-gray-100">
                                                        ...
                                                        <tbody id="result">
                                                            <tr class="bg-white border-b dark:bg-gray-100 dark:border-gray-700">
                                                                <td scope="row"  class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-black"></td>
                                                                <td scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-blck"></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>                       
