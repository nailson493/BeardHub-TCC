                                ...
                                <form action="#" method="POST w-full">
                                    <div class="overflow-hidden shadow sm:rounded-md ">
                                        ...
                                        <label for="country" class="block text-sm font-medium text-gray-700">Segunda</label>
                                            <select id="segunda" name="segunda" autocomplete="country-name" class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
