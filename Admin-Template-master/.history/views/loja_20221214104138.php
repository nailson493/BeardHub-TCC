                                ...
                                <form action="#" method="POST w-full">
                                    <div class="overflow-hidden shadow sm:rounded-md ">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="city" id="city" autocomplete="address-level2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></div>
                                        <div>
