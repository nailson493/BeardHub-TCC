                                        ...
                                        <div class="grid grid-cols-3 gap-4 w-[32rem] mb-4 mt-10 ">
                                          ...
                                          <div class="col-span-6 sm:col-span-1">
                                            ...
                                            <div class="col-span-6 sm:col-span-1">
                                              ...
                                              <!-- ... -->
                                              <div class="col-span-1">
                                              <label for="week-day" class="block text-sm font-medium text-gray-700">ednesday</label>
                                              <select id="wednesday" name="tuesday" autocomplete="tuesday-name" onchange="quarta()" class="mt-1 block w-full rounded-md border w-full border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                                  <option value="open" >Aberto</option>
                                                  <option value="closed" >Fechado</option>
                                              </select>
                                            </div>
