                            ...
                            <div class="mt-5 md:col-span-2 md:mt-0  w-full">
                                <form action="#" method="POST w-full">
                                    <div class="overflow-hidden shadow sm:rounded-md ">
                                        ...
                                        <div class=" mb-5 ">
                                            <label for="city" class="block text-sm font-medium text-gray-700">Segunda</label>
                                            <input type="text" name="city" id="city" autocomplete="address-level2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        ...
                                        <div>
                                        <label for="city" class="block text-sm font-medium text-gray-700">Terça</label>
                                            <input type="text" name="city" id="city" autocomplete="address-level2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                            <label for="city" class="block text-sm font-medium text-green-700">Inicio</label>
                                            <input type="text" name="city" id="city" autocomplete="address-level2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                            <label for="city" class="block text-sm font-medium text-red-700">Encerramento</label>
                                        ...
                                        <div>
                                        <label for="city" class="block text-sm font-medium text-gray-700">Quarta</label>
                                            <input type="text" name="city" id="city" autocomplete="address-level2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                            <label for="city" class="block text-sm font-medium text-green-700">Inicio</label>
                                            <input type="text" name="city" id="city" autocomplete="address-level2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                            <label for="city" class="block text-sm font-medium text-red-700">Encerramento</label>
                                        ...
                                        <div>
                                        <label for="city" class="block text-sm font-medium text-gr-700">Quinta</label>
                                            <input type="text" name="city" id="city" autocomplete="address-level2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                            <label for="city" class="block text-sm font-medium text-gray-700">Inicio</label>
                                            <input type="text" name="city" id="city" autocomplete="address-level2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                            <label for="city" class="block text-sm font-medium text-gray-700">Encerramento</label>
                                            <input type="text" name="city" id="city" autocomplete="address-level2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        </div>
                                        <div>
