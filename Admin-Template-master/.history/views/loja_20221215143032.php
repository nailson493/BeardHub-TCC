                                ...
                                <form  action="#" method="POST">
                                    <div  class="overflow-hidden shadow sm:rounded-md ">
                                        ...
                                        <div  class="grid grid-cols-6 gap-6">
                                            ...
                                            <input type="text" name="estabelecimento-name" id="first-name" autocomplete="given-name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                            </div>
                                        ...
                                        <div class="col-span-2 "> 
                                          ...
                                          <div class="w-96 text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-100 rounded-t-lg -pt-1 mt-10">
