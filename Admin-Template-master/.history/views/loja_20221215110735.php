    ...
    <div class="flex flex-col md:flex-row">
        ...
        <section class="w-full">
            <div id="main" class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
                ...
                <div id="full" class="flex flex-row flex-wrap flex-grow mt-2 ml-14 ">
                    <div id="full" class="mt-10 sm:mt-0 ">
                        <div class="md:grid md:grid-cols-3 md:gap-6">
                            <div id="full" class="mt-5 md:col-span-2 md:mt-0  ">
                                <form id="full" action="#" method="POST">
                                    <div id="full" class="overflow-hidden shadow sm:rounded-md ">
                                        <div id="full" class="bg-white px-4 py-5 sm:p-6">
                                        <div id="full" class="grid grid-cols-6 gap-6">
                                            <div id="full" class="col-span-6 sm:col-span-3">
