...
<script>       
		...
		function segunda() {
			...
			function sexta() {
                d = document.getElementById("friday").value;
                if (d == 'open'){
                	document.getElementById("closed-friday").removeAttribute("disabled");
                	document.getElementById("open-friday").removeAttribute("disabled");                  
                } else if (d == 'closed'){  
                	document.getElementById('closed-friday').value="";
                	document.getElementById('open-friday').value="";
                	document.getElementById("closed-friday").setAttribute("disabled", "disabled");
                	document.getElementById("open-friday").setAttribute("disabled", "disabled");
                }
            }
			
			
			function sabado() {
                d = document.getElementById("saturday").value;
                if (d == 'open'){
                	document.getElementById("closed-saturday").removeAttribute("disabled");
                	document.getElementById("open-saturday").removeAttribute("disabled");                  
                } else if (d == 'closed'){  
                	document.getElementById('closed-saturday').value="";
                	document.getElementById('open-saturday').value="";
                	document.getElementById("closed-saturday").setAttribute("disabled", "disabled");
                	document.getElementById("open-saturday").setAttribute("disabled", "disabled");
                }
            }	

			function domingo() {
                d = document.getElementById("sunday").value;
                if (d == 'open'){
                	document.getElementById("closed-sunday").removeAttribute("disabled");
                	document.getElementById("open-sunday").removeAttribute("disabled");                  
                } else if (d == 'closed'){  
                	document.getElementById('closed-sunday').value="";
                	document.getElementById('open-sunday').value="";
                	document.getElementById("closed-sunday").setAttribute("disabled", "disabled");
                	document.getElementById("open-sunday").setAttribute("disabled", "disabled");
                }
            }	
